...
import (
	...
	"github.com/faasplatform/event-driven-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "ea30b2b7.faasplatform",
	...
	if err = (&controller.FaaSDeploymentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "FaaSDeployment")
		os.Exit(1)
	}
